                            ...
                            <tbody class="list">
                                @forelse($brands as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <x-toggle-switch class="change_status" :checked="$brand->top" data-id="{{ $brand->id }}" />
                                        </td>
...
@push('breadcrumb-plugins')
    <div class="d-flex justify-content-end align-items-center flex-wrap gap-2 has-search-form">
        ...
        @if (!$trashed)
            <button type="button" class="btn btn-sm btn-outline--primary h-45 cuModalBtn flex-shrink-0 flex-grow-1 addBtn" data-modal_title="@lang('Add New Brand')" data-default_image="{{ getImage(null, getFileSize('brand')) }}">
