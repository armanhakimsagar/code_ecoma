                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="text--info d-none userCountText"> <i class="las la-info-circle"></i> <strong class="userCount">0</strong> @lang('active users found to send the notification')</small>
                                </div>
    ...
    <script>
        ...
        (function($) {
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDSELLERS') {
                    $('.input-append').html(`
                    <div class="form-group" id="seller_list_wrapper">
                        <label class="required">@lang('Select User')</label>
                        <select name="seller[]"  class="form-control" id="seller_list" required multiple >
                ...
                if (methodName == 'TOPDEPOSITEDSELLERS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required">@lang('Number Of Top Deposited Seller')</label>
                        <input class="form-control" type="number" name="number_of_top_deposited_seller" >
                    </div>
                    `);
                    return;
                }

                if (methodName == 'NOTLOGINSELLERS') {
                    $('.input-append').html(`
                    <div class="form-group">
            ...
            function fetchSellerList() {
                ...
                $('.row #seller_list').select2({
                    ajax: {
                        url: "{{ route('admin.sellers.list') }}",
                        type: "get",
                        dataType: 'json',
                        delay: 1000,
                        ...
                        processResults: function(response, params) {
                            ...
                            let data = response.sellers.data;
                            return {
                    ...
                    dropdownParent: $('.input-append #seller_list_wrapper')
                });
