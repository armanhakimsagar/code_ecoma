        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-4 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.order.all', $user->id) }}" title="Total Shopping" icon="las la-wallet" value="{{ showAmount($totalShopping) }}" bg="deep-purple" type="2" />
                </div>

                <div class="col-xxl-4 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.report.user.transaction', $user->id) }}" title="Total Transactions" icon="la la-exchange-alt" value="{{ getAmount($totalTransaction) }}" bg="indigo" type="2" />
                </div>

                <div class="col-xxl-4 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.report.order', $user->id) }}" title="Total Orders" icon="las la-cart-plus" value="{{ $totalOrders }}" bg="12" type="2" />
                </div>
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    <a href="{{ route('admin.report.user.login.history') }}?search={{ $user->username }}" class="btn btn--primary btn--shadow w-100 btn-lg">
