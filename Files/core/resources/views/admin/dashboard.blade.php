        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="6"
                        link="{{route('admin.order.all')}}"
                        icon="las la-list"
                        title="All Orders"
                        value="{{$widget['all_orders']}}"
                        bg="orange"
                    />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-sm-6">
        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="1"
                        link="{{route('admin.sellers.all')}}"
                        icon="las la-user-tie"
                        title="Total Sellers"
                        value="{{$widget['total_seller']}}"
                        bg="primary"
                    />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="1"
                        link="{{route('admin.sellers.active')}}"
                        icon="las la-user-check"
                        title="Active Sellers"
                        value="{{$widget['total_active_seller']}}"
                        bg="success"
                    />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        ...
                        value="{{ gs('cur_sym') .showAmount($widget['total_sell_amount'], currencyFormat:false) }}"
                        bg="success"
                    />
                </div>
            </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h5 class="card-title">@lang('Sales & Withdraw Report')</h5>
...
@push('script')
    <script>
        ...
        const depositWithdrawChart = (startDate, endDate) => {
            ...
            const url = @json(route('admin.chart.sales.withdraw'));
