                            ...
                            <tbody class="list">
                                @forelse($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-outline--primary confirmationBtn" data-id='{{ $category->id }}' data-action="{{ route('admin.category.delete', $category->id) }}" data-question="@lang('Are you sure to restore this category?')"><i class="las la-trash-restore"></i>@lang('Restore')
                                            </button>
                                        </td>
                                    </tr>
                                @empty
