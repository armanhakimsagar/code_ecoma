                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="user-profile">
                                    <div class="thumb">
                                        <img id="imagePreview" src="{{ getAvatar(getFilePath('userProfile') . '/' . $user->image) }}" alt="@lang('user')">
                                    ...
                                    <div class="content">
                                        ...
                                        <span class="d-block">@lang('Mobile'): +{{ $user->mobileNumber }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8 col-md-6">
                                <form action="" method="post" enctype="multipart/form-data" class="user-profile-form row mb--20">
                                    ...
                                    <div class="col-lg-6 mb-20">
                                        ...
                                        <input type="text" class="form-control custom--style" placeholder="@lang('Country')" value="{{ @$user->country_name }}" readonly>
                                    </div>

                                    <div class="col-lg-6 mb-20">
                                        <label for="state" class="billing-label">@lang('State'):</label>
                                        <input type="text" class="form-control custom--style" id="state" name="state" placeholder="@lang('state')" value="{{ @$user->state }}">
                                    </div>

                                    <div class="col-lg-6 mb-20">
                                        <label for="city" class="billing-label">@lang('City'):</label>
                                        <input type="text" class="form-control custom--style" id="city" name="city" placeholder="@lang('City')" value="{{ @$user->city }}">
                                    </div>

                                    <div class="col-lg-6 mb-20">
                                        <label for="zip" class="billing-label">@lang('Zip Code'):</label>
                                        <input type="text" class="form-control custom--style" id="zip" name="zip" placeholder="@lang('Zip Code')" value="{{ @$user->zip }}">
                                    </div>

                                    <div class="col-md-12 mb-20">
                                        <label for="address" class="billing-label">@lang('Address'):</label>
                                        <textarea type="text" rows="2" class="form-control custom--style" id="address" name="address" placeholder="@lang('Address')">{{ @$user->address }}</textarea>
                                    </div>
