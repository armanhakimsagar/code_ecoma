            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 d-none d-lg-block">
                        <img class="w-100" src="{{ frontendImage('register_page', @$content->data_values->image, '650x980') }}" alt="register-bg">
                    </div>
                        ...
                        <form action="{{ route('user.register') }}" method="POST" class="verify-gcaptcha disableSubmission">
                            ...
                            <div class="contact-group">
                                ...
                                <div class="multi-group">
                                    <input id="password" type="password" class="form-control w-100" name="password" required class="w-100 @if (gs('secure_password')) secure-password @endif">
                                </div>
                            </div>
