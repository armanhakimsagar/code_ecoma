        ...
        <div class="header-top-wrap d-flex flex-wrap justify-content-between align-items-center">
            ...
            @if (gs('multi_language'))
                ...
                <div class="dropdown dropdown--lang">
                    <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="dropdown-flag lazyload" src="{{ getImage(getFilePath('language') . '/' . @$activeLanguage->image, getFileSize('language')) }}" alt="@lang('image')">
                    ...
                    <div class="dropdown-menu">
                        @foreach ($language as $lang)
                            <a class="dropdown-item" href="{{ route('lang', $lang->code) }}">
                                <img class="dropdown-flag lazyload" src="{{ getImage(getFilePath('language') . '/' . @$lang->image, getFileSize('language')) }}" alt="country">
            ...
            <div class="right-side">
                <ul class="menu ml-auto d-none d-lg-flex">
                    ...
                    @auth
                        <li>
                            <a href="{{ route('ticket.index') }}">@lang('Support')</a>
                        </li>
                    @else
                        <li>
...
<div class="mobile-menu d-lg-none">
    ...
    <ul class="nav-tabs nav border-0">
        <li>
            <a href="#menu" class="active" data-bs-toggle="tab">@lang('Menu')</a>
        </li>
        <li>
            <a href="#cate" data-bs-toggle="tab">@lang('Categories')</a>
        </li>
    </ul>
...
@include('Template::partials.side_modal')
