                ...
                <div class="card-body">
                    <form action="{{ route('seller.ticket.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <button class="btn btn--primary h-45 w-100 my-2" type="submit"><i class="las la-paper-plane"></i> @lang('Submit')
                                </button>
                            </div>
                        </div>
...
@push('breadcrumb-plugins')
    <a href="{{ route('seller.ticket.index') }}" class="btn btn-sm btn-outline--primary">
