                ...
                <div class="row">
                    <div class="col-lg-4 col-xl-3 col-sm-5">
                        <div class="form-group">
                            <label>@lang('Shop Logo')</label>
                            <x-image-uploader type="sellerShopLogo" name="image" :image="@$shop->logo" class="w-100" id="shopLogo" :hasSize="false" :required="@$shop ? false : true" :showMessage="false" />
                            <div class="mt-2">
                    ...
                    <div class="col-lg-8 col-xl-9 col-sm-7">
                        <div class="form-group">
                            <label>@lang('Shop Cover Photo')</label>
                            <x-image-uploader type="sellerShopCover" name="cover_image" :image="@$shop->cover" class="w-100" id="shopCoverPhoto" :required="@$shop ? false : true" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="time" class="form-control" placeholder="--:--" name="opening_time" autocomplete="off" value="{{ old('opening_time', showDateTime(@$shop->opens_at, 'H:i')) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="time" class="form-control" value="{{ old('closing_time', showDateTime(@$shop->closed_at, 'H:i')) }}" placeholder="--:--" name="closing_time" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
...
@if (seller()->shop)
    @push('breadcrumb-plugins')
        <a href="{{ route('seller.details', [$seller->id, slug($seller->shop->name)]) }}" target="_blank" class="btn btn-sm btn-outline--primary"><i class="lab la-telegram-plane"></i>@lang('Visit Shop')</a>
    @endpush
@endif
